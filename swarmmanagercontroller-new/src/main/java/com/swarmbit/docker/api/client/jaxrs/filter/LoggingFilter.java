...
/**
 * Universal logging com.swarmbit.docker.api.client.jaxrs.filter.
 *
...
public class LoggingFilter implements ContainerRequestFilter, ClientRequestFilter, ContainerResponseFilter,
    ...
    /**
     * Create a logging com.swarmbit.docker.api.client.jaxrs.filter logging the request and response to a default JDK logger, named as the fully qualified class name of this
    ...
    /**
     * Create a logging com.swarmbit.docker.api.client.jaxrs.filter with custom logger and custom settings of entity logging.
     *
     * @param logger
    ...
    /**
     * Creates a logging com.swarmbit.docker.api.client.jaxrs.filter with custom logger and entity logging turned on, but potentially limiting the size of entity to be buffered
     * and logged.
     *
     * @param logger
     *            the logger to log requests and responses.
     * @param maxEntitySize
     *            maximum number of entity bytes to be logged (and buffered) - if the entity is larger, logging com.swarmbit.docker.api.client.jaxrs.filter will print (and
